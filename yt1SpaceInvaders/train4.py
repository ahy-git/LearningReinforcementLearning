...
checkpoint_dir = "./dqn_checkpoints_4/"
...
if os.path.exists(model_path):
    ...
    model = DQN(
        "CnnPolicy",
        env,
        buffer_size=500_000,  # Replay buffer grande
    ...
    model.save(os.path.join(checkpoint_dir, "dqn_space_invaders_train4_latest.zip"))
